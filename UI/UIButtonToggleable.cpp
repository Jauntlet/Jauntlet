...
UIButtonToggleable::UIButtonToggleable(InputManager* inputManager, std::function<void()> onClick, unsigned int textureId, glm::vec2* position, glm::vec2 size, ORIGIN_PIN positionPinType) {
